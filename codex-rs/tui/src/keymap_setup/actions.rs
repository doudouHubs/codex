...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "toggle_rules_sidebar", "Show or hide the rules sidebar."),
    ...
    action("rules_sidebar", "Rules sidebar", "transcript_jump_top", "Jump the transcript column to the beginning."),
    action("rules_sidebar", "Rules sidebar", "transcript_jump_bottom", "Jump the transcript column to the end."),
    action("rules_sidebar", "Rules sidebar", "scroll_up", "Scroll rules up by one row."),
    action("rules_sidebar", "Rules sidebar", "scroll_down", "Scroll rules down by one row."),
    action("rules_sidebar", "Rules sidebar", "page_up", "Scroll rules up by one page."),
    action("rules_sidebar", "Rules sidebar", "page_down", "Scroll rules down by one page."),
    action("rules_sidebar", "Rules sidebar", "close", "Close the rules sidebar."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_rules_sidebar") => Some(&mut keymap.global.toggle_rules_sidebar),
        ...
        ("rules_sidebar", "transcript_jump_top") => Some(&mut keymap.rules_sidebar.transcript_jump_top),
        ("rules_sidebar", "transcript_jump_bottom") => Some(&mut keymap.rules_sidebar.transcript_jump_bottom),
        ("rules_sidebar", "scroll_up") => Some(&mut keymap.rules_sidebar.scroll_up),
        ("rules_sidebar", "scroll_down") => Some(&mut keymap.rules_sidebar.scroll_down),
        ("rules_sidebar", "page_up") => Some(&mut keymap.rules_sidebar.page_up),
        ("rules_sidebar", "page_down") => Some(&mut keymap.rules_sidebar.page_down),
        ("rules_sidebar", "close") => Some(&mut keymap.rules_sidebar.close),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_rules_sidebar") => Some(runtime_keymap.app.toggle_rules_sidebar.as_slice()),
        ...
        ("rules_sidebar", "transcript_jump_top") => Some(runtime_keymap.rules_sidebar.transcript_jump_top.as_slice()),
        ("rules_sidebar", "transcript_jump_bottom") => Some(runtime_keymap.rules_sidebar.transcript_jump_bottom.as_slice()),
        ("rules_sidebar", "scroll_up") => Some(runtime_keymap.rules_sidebar.scroll_up.as_slice()),
        ("rules_sidebar", "scroll_down") => Some(runtime_keymap.rules_sidebar.scroll_down.as_slice()),
        ("rules_sidebar", "page_up") => Some(runtime_keymap.rules_sidebar.page_up.as_slice()),
        ("rules_sidebar", "page_down") => Some(runtime_keymap.rules_sidebar.page_down.as_slice()),
        ("rules_sidebar", "close") => Some(runtime_keymap.rules_sidebar.close.as_slice()),
